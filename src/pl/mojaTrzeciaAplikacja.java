...
public class mojaTrzeciaAplikacja {
    public static void main(String[] args) {
       ...
       /* Scanner scanner = new Scanner(System.in);
        ...
        System.out.println("Podaj liczbę dni, a ja zamienię je na tygodnie i dni:");
        ...
        while (true) {
            ...
            int tygodnie = dni / 7;
            int pozostałeDni = dni % 7;

            System.out.println(dni + " dni to " + tygodnie + " tygodnie i " + pozostałeDni + " dni.");
            System.out.println("Podaj kolejną liczbę dni lub wpisz liczbę niedodatnią, aby zakończyć:");
        }

        System.out.println("Teraz podaj temperaturę w skali Fahrenheita (wpisz -1, aby zakończyć):");
        ...
        while (true) {
            ...
            System.out.printf("%.2f °F to %.2f °C i %.2f K\n", fahrenheit, celsius, kelvin);
            System.out.println("Podaj kolejną temperaturę w Fahrenheitach lub wpisz -1, aby zakończyć:");
        }
